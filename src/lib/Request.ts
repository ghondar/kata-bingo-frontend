...
const { REACT_APP_REST_API_LOCATION = 'http://localhost:3001', REACT_APP_API_VERSION = 'v1' } = process.env

export const baseURL = REACT_APP_REST_API_LOCATION + '/api/' + REACT_APP_API_VERSION + '/bingo/'
